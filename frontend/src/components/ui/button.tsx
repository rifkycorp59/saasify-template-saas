...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg shadow-elegant hover:shadow-glow transform hover:scale-105",
        destructive:
        ...
        ghost: "hover:bg-accent hover:text-accent-foreground dark:text-white rounded-lg",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-gradient-primary text-primary-foreground dark:text-white rounded-full px-8 py-3 font-semibold shadow-elegant hover:shadow-glow transform hover:scale-105",
        premium: "bg-success text-success-foreground hover:bg-success/90 rounded-lg shadow-elegant transform hover:scale-105",
      },
      size: {
