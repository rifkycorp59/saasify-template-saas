    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-fade-in">
            Ready to Scale
            <span className="block mt-2">Your Bussines?</span>
          </h2>
          
          {/* Subheading */}
          <p className="text-lg md:text-xl text-white/90 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in">
            Join thousands of companies that trust our platform to scale their business 
            to the next level and achieve unprecedented growth.
          </p>

          {/* CTA buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 animate-scale-in">
            <button className="group bg-white text-primary font-semibold px-8 py-4 rounded-lg hover:bg-white/90 transition-smooth shadow-elegant hover:shadow-glow hover:scale-105">
            ...
            <button className="group bg-transparent border-2 border-white text-white font-semibold px-8 py-4 rounded-lg hover:bg-white hover:text-primary transition-smooth">
              <span className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center opacity-80">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-white/80">Days Free</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-full">
        <svg className="w-full h-16" viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path d="M0,60 C300,100 900,20 1200,60 L1200,120 L0,120 Z" fill="white" fillOpacity="0.1"></path>
        </svg>
      </div>
    </section>
  );
